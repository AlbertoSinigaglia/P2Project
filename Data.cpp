...
public:
    ...
    unsigned int getGiorno() { return giorno; }
    unsigned int getMese() { return mese; }
    ...
    Data operator-(
            const Data &d);   // restituisce un valore Data approssimato di quella che è la distanza temporale assoluta tra le due date
